		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form"
					action="${pageContext.request.contextPath }/post/upd.action"
						...
						<div class="form-group  form-group-lg">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control input-lg" id="name"
									name="name" value="${post.name }" required autofocus>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control input-lg" id="text"
									name="text" value="${post.text }" required autofocus>
							</div>
						</div>
						<!-- 重要-日期和图片的获取方式 -->
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control input-lg form_datetime"
									value="<fmt:formatDate value="${post.time}" 
							pattern="yyyy-MM-dd"/>"
									name="time" id="time">
							</div>
						</div>
						<div class="form-group">
							<label for="lastname" class="col-sm-3 control-label">发贴人:</label>
							<div class="col-sm-5">
								<input type="text" class="form-control input-lg" id="Authorid"
									name="Authorid" value="${post.Authorid}" required autofocus>
							</div>
						</div>
					</div>
					<!-- 模态框的尾部 -->
					<div class="modal-footer">
						...
						<a href="${pageContext.request.contextPath }/post/queryPost.action" >返回</a></button> 
